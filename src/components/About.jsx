...
const About = () => {
  ...
  return (
    <div className={`relative h-auto py-[10px] px-3 items-center flex-1 ${isMobile ? 'bg-tertiary':'bg-transparent'}`}>
      ...
      <div className="mt-4 text-white text-[17px] max-w-3xl font-montserrat leading-[30px] text-justify justify-center items-center">
