  ...
  return(
    <div className='xl:mt-12 xl:flex-row flex-col-reverse gap-10 overflow-hidden'>
      <motion.div variants={slideIn('left', 'tween', 0.2, 1)} className='flex-[0.75] bg-transparent rounded-2xl'>
        ...
        <div className='inline-block'><h3 className={styles.sectionHeadText}>Feedback.</h3></div>
        ...
        <div className='button-container py-10'>
          <button 
            type='submit' 
            className='bg-tertiary send-link py-4 outline-none w-fit text-white border-[1px] font-bold shadow-md
